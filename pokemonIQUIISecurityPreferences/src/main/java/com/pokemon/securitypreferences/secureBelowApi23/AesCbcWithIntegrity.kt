...
/*
    ...
    fun decryptString(
        ...
        return String(decrypt(civ, secretKeys), Charset.forName(encoding))
    }
    ...
    ): ByteArray { //Now compute the mac for later integrity checking
     ...
     */
    class SecretKeys(confidentialityKeyIn: SecretKey?, integrityKeyIn: SecretKey?) {
        ...
        override fun toString(): String {
            return (Base64.encodeToString(confidentialityKey!!.encoded, BASE64_FLAGS)
                    + ":" + Base64.encodeToString(integrityKey!!.encoded, BASE64_FLAGS))
        }
    ...
    class CipherTextIvMac {
        ...
        constructor(base64IvAndCiphertext: String) {
            val civArray = base64IvAndCiphertext.split(":").toTypedArray()
        ...
        private fun applyOpenSSLFix() {
            ...
            try { // Mix in the device- and invocation-specific seed.
                Class.forName("org.apache.harmony.xnet.provider.jsse.NativeCrypto")
                    ...
                    .invoke(null, *arrayOf(generateSeed()))
