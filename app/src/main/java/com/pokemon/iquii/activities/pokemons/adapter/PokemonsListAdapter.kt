...
class PokemonsListAdapter :
    ...
    private fun bindNotificationCard(holder: NotificationCardViewHolder, position: Int) {
    ...
    inner class NotificationCardViewHolder(internal val binding: PokemonCardBinding) :
